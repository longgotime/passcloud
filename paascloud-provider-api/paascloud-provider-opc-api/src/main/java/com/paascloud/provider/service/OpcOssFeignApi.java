...
import com.paascloud.provider.service.hystrix.OpcOssFeignHystrix;
 ...
 */
@FeignClient(value = "paascloud-provider-opc", configuration = OAuth2FeignAutoConfiguration.class, fallback = OpcOssFeignHystrix.class)
public interface OpcOssFeignApi {
	 ...
	 * @return the wrapper
	 */
	@PostMapping(value = "/opc/opc/oss/uploadFile")
	Wrapper<OptUploadFileRespDto> uploadFile(@RequestBody OptUploadFileReqDto optUploadFileReqDto);

	/**
	 * 上传文件.
	 *
	 * @param fileReqDtoList the file req dto list
	 * @return the wrapper
	 */
	@PostMapping(value = "/opc/opc/oss/uploadFiles")
	Wrapper<List<OptUploadFileRespDto>> uploadFiles(@RequestBody List<OptUploadFileReqDto> fileReqDtoList);
	 ...
	 * @return the file url
	 */
	@PostMapping(value = "/opc/opc/oss/getFileUrl")
	 ...
	 * @return the wrapper
	 */
	@PostMapping(value = "/opc/opc/oss/listFileUrl")
	 ...
	 * @return the wrapper
	 */
	@PostMapping(value = "/opc/opc/oss/handleFileUpload")
	Wrapper<OptUploadFileRespDto> handleFileUpload(@RequestPart(value = "file") MultipartFile file);

	/**
	 * 删除过期的文件.
	 */
	@PostMapping(value = "/opc/opc/oss/deleteExpireFile")
