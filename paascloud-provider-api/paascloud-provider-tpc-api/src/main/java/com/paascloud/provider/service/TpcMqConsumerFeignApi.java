...
public interface TpcMqConsumerFeignApi {
     ...
     * @return the wrapper
     */
    @PostMapping(value = "/api/tpc/consumer/queryConsumerVoListWithPage")
     ...
     * @return the wrapper
     */
    @PostMapping(value = "/api/tpc/consumer/querySubscribeListWithPage")
     ...
     * @return the wrapper
     */
    @PostMapping(value = "/api/tpc/consumer/modifyStatusById")
     ...
     * @return the wrapper
     */
    @PostMapping(value = "/api/tpc/consumer/deleteById/{id}")
