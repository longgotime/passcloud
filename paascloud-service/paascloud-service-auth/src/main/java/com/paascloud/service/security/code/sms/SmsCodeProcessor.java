...
import com.paascloud.config.properties.SmsCodeProperties;
...
import com.paascloud.service.security.code.ValidateCodeException;
import com.paascloud.service.security.code.ValidateCodeGenerator;
import com.paascloud.service.security.code.ValidateCodeRepository;
import com.paascloud.service.security.code.impl.AbstractValidateCodeProcessor;
...
public class SmsCodeProcessor extends AbstractValidateCodeProcessor<ValidateCode> {
	...
	private void checkSendSmsCount(String mobile, String ipAddr) {
		...
		SmsCodeProperties sms = paascloudProperties.getSecurity().getCode().getSms();
