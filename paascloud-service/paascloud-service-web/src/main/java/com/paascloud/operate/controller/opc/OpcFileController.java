...
package com.paascloud.operate.controller.opc;
 ...
 */
@RestController
@RequestMapping(value = "/web/file", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
@Api(value = "WEB - OpcFileController", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
public class OpcFileController extends BaseController {
    ...
    public Wrapper<String> uploadFile(HttpServletRequest request, OptUploadFileReqDto optUploadFileReqDto) {
        ...
        List<OptUploadFileRespDto> optUploadFileRespDtos = fileService.uploadFile(multipartRequest, optUploadFileReqDto, getLoginAuthDto(), true);
    ...
    public Map<String, Object> uploadPictureWithWangEditor(HttpServletRequest request, OptUploadFileReqDto optUploadFileReqDto) {
        ...
        MultipartHttpServletRequest multipartRequest = (MultipartHttpServletRequest) request;
        optUploadFileReqDto.setStoreDb(false);
        List<OptUploadFileRespDto> optUploadFileRespDtos = fileService.uploadFile(multipartRequest, optUploadFileReqDto, getLoginAuthDto(), false);
    ...
    public Wrapper<OptAttachmentRespDto> queryAttachment(@PathVariable("id") Long id) {
        ...
        return opcFileFeignApi.queryAttachment(id);
    }
    ...
    public Wrapper<List<OptAttachmentRespDto>> queryAttachmentListByRefNo(@PathVariable("refNo") String refNo) {
        ...
        return opcFileFeignApi.queryAttachmentListByRefNo(refNo);
    }
    ...
    public Wrapper deleteAttachment(@PathVariable("attachmentId") Long attachmentId) {
        ...
        return opcFileFeignApi.deleteAttachment(attachmentId);
    }
}
