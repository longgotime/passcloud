 ...
 * 类名称：MdcExceptionController.java
 * 创建人：刘兆明
...
@Api(value = "Web - MdcExceptionController", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
public class MdcExceptionController extends BaseController {
    @Resource
    private MdcExceptionFeignApi mdcExceptionFeignApi;
    ...
    public Wrapper queryLogListWithPage(@ApiParam(name = "mdcExceptionQueryDto", value = "异常查询条件") @RequestBody MdcExceptionQueryDto mdcExceptionQueryDto) {
        ...
        return mdcExceptionFeignApi.queryLogListWithPage(mdcExceptionQueryDto);
    }
}
