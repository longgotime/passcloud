 ...
 */
@RestController
@RequestMapping(value = "/web/producer", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
...
public class TpcMqProducerController extends BaseController {
    ...
    @Resource
    private TpcMqProducerFeignApi tpcMqProducerFeignApi;
    ...
    public Wrapper<List<TpcMqProducerVo>> queryProducerList(@ApiParam(name = "producer", value = "Mq生产者") @RequestBody TpcMqProducerQuery tpcMqProducer) {

        logger.info("查询生产者列表tpcMqTopicQuery={}", tpcMqProducer);

        return tpcMqProducerFeignApi.queryProducerList(tpcMqProducer);
    }
    ...
    public Wrapper<PageInfo<TpcMqPublishVo>> queryPublishListWithPage(@ApiParam(name = "producer", value = "Mq生产者") @RequestBody TpcMqProducerQuery tpcMqProducer) {
        logger.info("查询Mq发布列表tpcMqTopicQuery={}", tpcMqProducer);

        return tpcMqProducerFeignApi.queryPublishListWithPage(tpcMqProducer);
    }
    ...
    public Wrapper modifyProducerStatusById(@ApiParam(value = "修改producer状态") @RequestBody UpdateStatusDto updateStatusDto) {
        ...
        return tpcMqProducerFeignApi.modifyProducerStatusById(updateStatusDto);
    }
    ...
    public Wrapper deleteProducerById(@PathVariable Long id) {
        ...
        return tpcMqProducerFeignApi.deleteProducerById(id);
    }
}
